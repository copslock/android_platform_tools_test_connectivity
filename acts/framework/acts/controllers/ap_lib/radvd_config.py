...
class RadvdConfig(object):
    ...
    def __init__(self,
        ...
        self._rdnss = rdnss
        self._ignore_if_missing = str(ignore_if_missing)
        self._adv_send_advert = str(adv_send_advert)
        self._unicast_only = str(unicast_only)
        self._max_rtr_adv_interval = str(max_rtr_adv_interval)
        self._min_rtr_adv_interval = str(min_rtr_adv_interval)
        self._min_delay_between_ras = str(min_delay_between_ras)
        self._adv_managed_flag = str(adv_managed_flag)
        self._adv_other_config_flag = str(adv_other_config_flag)
        self._adv_link_mtu = str(adv_link_mtu)
        self._adv_reachable_time = str(adv_reachable_time)
        self._adv_retrans_timer = str(adv_retrans_timer)
        self._adv_cur_hop_limit = str(adv_cur_hop_limit)
        self._adv_default_lifetime = str(adv_default_lifetime)
        self._adv_default_preference = str(adv_default_preference)
        self._adv_source_ll_address = str(adv_source_ll_address)
        self._adv_home_agent_flag = str(adv_home_agent_flag)
        self._adv_home_agent_info = str(adv_home_agent_info)
        self._home_agent_lifetime = str(home_agent_lifetime)
        self._home_agent_preference = str(home_agent_preference)
        self._adv_mob_rtr_support_flag = str(adv_mob_rtr_support_flag)
        self._adv_interval_opt = str(adv_interval_opt)
        self._adv_on_link = str(adv_on_link)
        self._adv_autonomous = str(adv_autonomous)
        self._adv_router_addr = str(adv_router_addr)
        self._adv_valid_lifetime = str(adv_valid_lifetime)
        self._adv_preferred_lifetime = str(adv_preferred_lifetime)
        self._base_6to4_interface = str(base_6to4_interface)
        self._adv_route_lifetime = str(adv_route_lifetime)
        self._adv_route_preference = str(adv_route_preference)
        self._adv_rdnss_preference = str(adv_rdnss_preference)
        self._adv_rdnss_open = str(adv_rdnss_open)
        self._adv_rdnss_lifetime = str(adv_rdnss_lifetime)
