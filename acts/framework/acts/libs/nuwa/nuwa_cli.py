...
class NuwaCli(object):
    ...
    frontend.
    """
    def __init__(self, nuwa_zip, nuwa_path, workflow_paths, log_path=None):
        """Creates a NuwaCli object. Extracts the required nuwa-cli binaries.

        Args:
            nuwa_zip: The path to nuwa-cli.tar.gz
            nuwa_path: The path to nuwa-cli binaries. The zip file will be
                extracted to here.
        ...
        self._nuwa_path = nuwa_path
        self._log_path = log_path
        os.makedirs(self._nuwa_path, exist_ok=True)
        if self._log_path:
