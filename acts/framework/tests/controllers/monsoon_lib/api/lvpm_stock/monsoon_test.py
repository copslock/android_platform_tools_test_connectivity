...
import mock
from acts.controllers.monsoon_lib.api.lvpm_stock.monsoon import Monsoon

ASSEMBLY_LINE_IMPORT = ('acts.controllers.monsoon_lib.api.lvpm_stock.monsoon'
                        '.AssemblyLineBuilder')
DOWNSAMPLER_IMPORT = ('acts.controllers.monsoon_lib.api.lvpm_stock.monsoon'
                      '.DownSampler')
TEE_IMPORT = 'acts.controllers.monsoon_lib.api.lvpm_stock.monsoon.Tee'
MONSOON_PROXY_IMPORT = ('acts.controllers.monsoon_lib.api.lvpm_stock.monsoon'
                        '.MonsoonProxy')
