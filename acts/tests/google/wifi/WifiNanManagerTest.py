...
class WifiNanManagerTest(base_test.BaseTestClass):
    ...
    def exec_connect(self, device, config_request, name):
        ...
        """
        session_id = device.droid.wifiNanAttach(config_request)
        try:
    ...
    def run_nan_discovery_session(self, discovery_config):
        ...
        try:
            ...
            self.publisher.droid.wifiNanDestroy(pub_connect_id)
            self.subscriber.droid.wifiNanDestroy(sub_connect_id)
    ...
    def test_disable_wifi_during_connection(self):
        ...
        # Start Test
        connect_id = self.dut.droid.wifiNanAttach(self.config_request1)
    ...
    def test_nan_data_path(self):
        ...
        try:
            ...
            self.publisher.droid.connectivityUnregisterNetworkCallback(pub_req_key)
