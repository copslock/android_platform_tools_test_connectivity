...
"""
    Test Script for Telephony Stress CSFB test
"""
...
class TelStressCSFBTest(BaseTestClass):
    TAG = "TelStressCSFBTest"
    ...
    def setup_class(self):
        ...
        # Add delay here to make sure phone not in unstable LTE mode.
    ...
    def _call_process_helper_csfb(self, params):
    ...
    def test_call_est_basic_csfb(self):
        """ Test CSFB call establishment basic ok on two phones.
        ...
        for i in range(int(self.stress_test_number)):
            ...
            failed = self.run_generated_testcases("Call establish test",
                                                  self._call_process_helper_csfb,
                                                  params)
